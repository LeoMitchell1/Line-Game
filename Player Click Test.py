...
def start_game():
    ...
    computer_count_text = "Computer's count: 0"
    player_count_text = "Player's count: 0"
    ...
    player_count_label = tk.Label(game_window, text=(player_count_text), font=('Arial', 16, 'bold'), bg='#18191A', fg='#FF1199')
    player_count_label.place(relx=0.1, rely=0.18, anchor=tk.SW)

    computer_count_label = tk.Label(game_window, text=(computer_count_text), font=('Arial', 16, 'bold'), bg='#18191A', fg='#11FFEE')
    ...
    def player1_turn(event):
        global computer_count_text
        global player_count_text
        global game_over

        if player_vs_player == True:
            computer_count_text = "Player 2's count: 0"
            player_count_text = "Player 1's count: 0"
    ...
    def update_player2_count():
        computer_count = count_longest_line(computer_lines)
        computer_count_label.config(text="Player2's count: " + str(computer_count))
